...
public class CategoryController {
    ...
    public ResponseEntity<SuccessResponseDto<List<Category>>> searchCategory (@ModelAttribute ReqSearchCategoryDto reqSearchCategory) throws Exception {
        System.out.println(reqSearchCategory);
        return ResponseEntity.ok().body(new SuccessResponseDto<>(categoryService.getCategories(reqSearchCategory)));
    }
}
